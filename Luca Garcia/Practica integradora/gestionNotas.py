...
# 2. Lista base de materias (Materia, Nota 1, Nota 2, Nota Final)
materias_base = [
...
# 3. Lista de notas finales: [Nombre Alumno, Promedio General]
notasFinales = []

# Proceso de carga e iteración
for legajo, nombre_alumno in alumnos.items():
    print(f"\n==========================================")
    print(f"Alumno: {nombre_alumno} (Legajo: {legajo})")
    print(f"==========================================")
    
    # Hacemos una copia de la estructura de materias para no sobreescribir datos globales
    ...
    # Recorremos cada materia para cargar las notas
    for m in materias_alumno:
        ...
        # Verificamos si es la materia con nota más alta del alumno
        if promedio_materia > nota_mas_alta:
            nota_mas_alta = promedio_materia
            materia_mas_alta = m[0]
            
    # Mostrar la lista de materias cargada completa para este alumno
...
# Determinar cuál de todos los alumnos posee el mejor promedio general
print("\n==========================================")
